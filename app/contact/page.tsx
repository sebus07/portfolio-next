...
const ProfileForm = () => {
    return (
        <div >
            <Header />
            <div className="flex justify-center w-full h-screen bg-cover bg-center" style={{ backgroundImage: "url('/images/photo3.jpg')" }}>
                    ...
                    <div className="space-y-12 bg-gray-500 p-5  mr-8 ml-8">
                        <div className="border-b border-gray-900/10 pb-12">
                            ...
                            <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div className="mt-3 flex justify-center mb8">
